...
public class MenuButton2 extends Group {
	...
	public MenuButton2( final String buttonText ) {
		...
		final float h = textLabel.getHeight() * 1.0f;
		final float w = textLabel.getWidth() * 3.45f;
		
		Image bgImage1 = new Image( GFX.get(IMG.BOX) );
		//bgImage1.setColor(Core.color[0]);
